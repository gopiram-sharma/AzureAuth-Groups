using AzureAuth.Groups.Infrastructure;
...
namespace AzureAuth.Groups
{
    public class Startup
    {
        ...
        {
            var initialScopes = new string[] { Infrastructure.Constants.ScopeUserRead, Infrastructure.Constants.ScopeGroupMemberRead };
